    ...
    render: function render() {
        ...
        var nodes = data.map(function (col, index) {
            ...
            if (_this.props.columnSettings.hasColumnMetadata() && typeof meta !== "undefined") {
                ...
                returnValue = meta == null ? returnValue : React.createElement('td', { onClick: _this.handleClick, className: meta.cssClassName, key: index, style: columnStyles }, firstColAppend, colData);
            }
